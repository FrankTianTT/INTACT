...
from tdfa.meta_dreamer.util import (
    call_record,
    EnvConfig,
    grad_norm,
    make_recorder_env,
...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    for i, tensordict in enumerate(collector):
        ...
        matched_tensordict = match_length(tensordict, cfg.batch_length)

        matched_tensordict = matched_tensordict.reshape(-1, cfg.batch_length)
        replay_buffer.extend(matched_tensordict.cpu())
        logger.log_scalar(
            "r_training",
