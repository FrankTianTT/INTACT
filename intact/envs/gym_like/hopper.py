...
class HopperEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        self._torso_x_vel_bias = torso_x_vel_bias
        self._torso_z_vel_bias = torso_z_vel_bias
        ...
        MujocoEnv.__init__(
            self, "hopper.xml", 1, observation_space=observation_space, **kwargs
        )
    ...
    def _step_mujoco_simulation(self, ctrl, n_frames):
        ...
        new_pos = old_pos + old_vel * self.model.opt.timestep
    ...
    def _get_obs(self):
        ...
        velocity[0] += self._torso_x_vel_bias
        velocity[1] += self._torso_z_vel_bias
        velocity[2] += self._torso_angle_vel_bias
    ...
    def step(self, action):
        ...
        forward_reward = self._forward_reward_weight * (2. - abs(self._goal_velocity - x_velocity))
...
if __name__ == '__main__':
    from intact.envs.termination_fns import hopper as hopper_termination_fns
